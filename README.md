...
We’ve introduced a major update to our UI kits. Version 4 features a modular architecture that gives you enhanced flexibility to build and customize your web and mobile apps. [Visiting our documentation](https://www.cometchat.com/docs/angular-uikit-beta/overview) to read more about this.
<br/><br/>
