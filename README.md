...
```javascript
  npm i @cometchat-pro/chat@3.0.0-beta1 --save
```
...
Visit our [Angular sample app](https://github.com/cometchat-pro/cometchat-pro-angular-sample-app/tree/v3) repo to run the Angular sample app.
