const smileys:string = "assets/resources/smileys.svg";
const animals:string = "assets/resources/animals.svg";
const activity :string= "assets/resources/activity.svg";
const flags:string = "assets/resources/flags.svg";
const objects:string = "assets/resources/objects.svg";
const symbols:string = "assets/resources/symbols.svg";
const travel:string = "assets/resources/travel.svg";
const food:string = "assets/resources/food.svg";
export const Emojis = [
  {
    people: {
      id: "people",
