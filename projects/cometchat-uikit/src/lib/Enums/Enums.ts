...
/**
 * Mention type enumeration for styling purposes.
 * Used to determine which CSS class to apply to a mention in text bubbles.
 *
 * @remarks
 * - `self`: Mention of the current logged-in user
 * - `other`: Mention of another user
 * - `channel`: Channel mention (@all)
 *
 * It is used in CometChatTextBubble and CometChatMentionsFormatter components.
 * @see Requirements 5.1, 5.2, 5.3, 5.4
 */
export enum MentionType {
  /** Mention of the current logged-in user */
  self = 'self',
