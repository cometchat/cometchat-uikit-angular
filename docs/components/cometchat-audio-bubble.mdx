...
| `expandChange` | `boolean` | Emitted when the audio bubble expands or collapses (e.g., showing/hiding multiple attachments). `true` when expanded, `false` when collapsed. |
